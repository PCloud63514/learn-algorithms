...
class Kakao2021Question5 {
    ...
    val ptimeSec = ConvertSecond(play_time)
        ...
        val logsStartSec:Array<Int> = Array<Int>(logs.size) { 0 }
        val logsEndSec:Array<Int> = Array<Int>(logs.size) { 0 }
        val totalTime:Array<Int> = Array<Int>(logs.size) { 0 }
    ...
    fun solution(play_time: String, adv_time: String, logs: Array<String>): String {
        ...
        val chaceArray:Array<Int> = Array<Int>(ptimeSec) { 0 }
        ...
        for(i in chaceArray.indices) {
            if(chaceArray.get(i) != 0) {
                println("i:" + i + "= " + chaceArray.get(i))
            }
        }
